    ...
    return (
        ...
        >
            <div className={`h-[8rem] items-center flex`}>
                ...
                <div
                    className='active:cursor-grabbing h-full min-w-fit px-4 grid place-items-center touch-none'
                    {...listeners}
                    {...attributes}
                >
                    <Image
                ...
                <div className='flex-1 flex flex-col gap-1'>
                    <div className='flex gap-3 items-center text-base cursor-pointer w-[95%]' onClick={handleTriggerEditTitle}>
                        {editingTitle ? <input
                            ...
                            ref={titleRef}
                        /> : <>
                            <span className='sm:font-semibold font-bold sm:text-base text-sm'>{titleText === "" ? "Headline title" : titleText}</span>
                    ...
                    <div className='flex gap-3 items-center relative text-sm opacity-100 cursor-pointer w-full' onClick={handleTriggerEditUrl}>
                        {editingUrl ? <input
                            ...
                            ref={urlRef}
                        /> : <>
                            <span className={`w-[10rem] truncate sm:w-fit ${urlIsValid === 1 ? 'text-red-500' : ''}`}>{urlText === "" ? "URL" : urlText}</span>
                            <FaPencil className='text-xs' />
                        </>}
                        {urlIsValid === 1 && <div

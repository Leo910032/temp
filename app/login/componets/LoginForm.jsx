// LoginForm.jsx - Complete Code with Medium Spacing Reduction
"use client"
...
export default function LoginForm() {
    ...
    */
    ...
    return (
        // ✅ Reduced vertical padding (py-8 -> py-4) and horizontal (sm:p-12 -> sm:p-8)
        <div className="flex-1 sm:p-8 px-4 py-4 flex flex-col overflow-y-auto">
            ...
            {/* ✅ Reduced vertical padding (py-10 -> py-4) */}
            <section className="mx-auto py-4 w-full sm:w-5/6 md:w-3/4 lg:w-2/3 xl:w-1/2 flex-1 flex flex-col justify-center">
                ...
                {/* ✅ Reduced vertical padding (py-8 sm:py-12 -> py-6 sm:py-8) and gap (gap-4 sm:gap-6 -> gap-4) */}
                <form className="py-6 sm:py-8 flex flex-col gap-4 w-full" onSubmit={handleSubmit}>
                    {/* ✅ Reduced vertical padding on inputs (py-2 sm:py-3 -> py-1 sm:py-2) and inner padding (py-3 -> py-2) */}
                    ...
                    {/* ✅ Reduced vertical padding on main button (py-4 sm:py-5 -> py-3 sm:py-4) */}
                    <button 
                        type="submit" 
                    ...
                    {/* ✅ Reduced vertical padding on social buttons (py-3 -> py-2) */}
